...
- Antigravity (Google) — current: `agy --print --dangerously-skip-permissions` (headless) or `antigravity chat` + oh-my-agent plugin (interactive); reuses `.gemini/agents/*.md` definitions
- Gemini CLI (deprecated as of 2026-05) — legacy: `gemini -p "@agent ..."` using `.gemini/agents/*.md`
