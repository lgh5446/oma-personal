---
name: oma-recap
description: Analyze conversation histories from multiple AI tools (Claude, Codex, Antigravity / Gemini, Qwen, Cursor) and generate themed daily/period work summaries. Filter by date or time window.
---
